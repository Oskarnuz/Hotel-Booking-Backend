...
const newsletterEmail = (mail) => {
    const styles = {
        container: "background: #f2f2f2; border: 1px solid #ddd; padding: 20px; font-family: sans-serif;",
        title: "font-size: 24px; font-weight: bold; margin-top: 0; margin-bottom: 20px;",
