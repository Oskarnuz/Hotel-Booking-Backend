...
exports.recoverEmail = void 0;
const recoverEmail = (password, UserUpdated) => {
    const styles = {
        ...
        button: "background-color: #007bff; color: #fff; border-radius: 5px; padding: 10px 20px; font-size: 16px; text-decoration: none;",
    ...
    const email = {
        ...
        subject: "Password Reset petition",
        html: `
      ...
      <h1 style="${styles.title}">You requested a change of password</h1>
        <p style="${styles.subtitle}" ${UserUpdated.fullName}, Here is your provisional password <strong>${password}</strong></p>
...
exports.recoverEmail = recoverEmail;
